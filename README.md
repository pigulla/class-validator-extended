...
| `@IsSubclass(clazz, options?)`             | Checks if the given value is an instance of `clazz` or one of its subclasses.                               |       [🔗](https://pigulla.github.io/class-validator-extended/modules.html#IsSet)        |
| **Common**                                 |                                                                                                             |                                                                                          |
