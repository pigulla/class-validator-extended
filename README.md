...
| `@MapIncludesKeys(value, options?)`          | Checks if the given value is a Map and includes only the `value` keys, with no others.                      |  [🔗](https://pigulla.github.io/class-validator-extended/functions/MapIncludesKeys.html)   |
