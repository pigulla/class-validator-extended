...
| `@IsDuration(options?)`                    | Checks if the given value is a valid Dayjs Duration object.                                                 |     [🔗](https://pigulla.github.io/class-validator-extended/modules.html#IsDuration)     |
